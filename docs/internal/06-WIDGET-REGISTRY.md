...
in Week 3, `weather` and `currency` in Week 4, `markets` in Week 5a, so
**eleven of fifteen** are registered as of 2026-09-01. `core/registry.test.ts` asserts every *registered*
